...
public class DiamondFurnace extends BlockTileEntityRotatable {
	...
	public ItemStack[] getBreakResult(World world, EnumDropCause dropCause, int x, int y, int z, int meta, TileEntity tileEntity) {
		switch (dropCause) {
			...
			case PROPER_TOOL:
			case SILK_TOUCH:
				return new ItemStack[]{new ItemStack(IronFurnaces.furnaceDiamondIdle)};
			default:
				return null;
		}
	}
	...
	public boolean blockActivated(World world, int x, int y, int z, EntityPlayer player) {
		if (!world.isClientSide) {
			TileEntityDiamondFurnace tileentitydiamondfurnace = (TileEntityDiamondFurnace)world.getBlockTileEntity(x, y, z);
			player.displayGUIFurnace(tileentitydiamondfurnace);
		}
	...
	public static void updateFurnaceBlockState(boolean lit, World world, int x, int y, int z) {
		...
		if (tileentity == null) {
			...
			if (lit) {
				world.setBlockWithNotify(x, y, z, config.getInt("ids.diamondFurnaceActiveID"));
			} else {
				world.setBlockWithNotify(x, y, z, config.getInt("ids.diamondFurnaceIdleID"));
			}
